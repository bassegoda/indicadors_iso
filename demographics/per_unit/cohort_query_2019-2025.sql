-- =====================================================================
-- Cohorte demografía + clínica E073/I073 (2019-2025) — variante PER-UNIT
-- =====================================================================
-- Pegar tal cual en Metabase (Native query, AWS Athena/Trino).
-- Resultado esperado: una fila por (paciente, episodio, unidad, estancia)
-- con prescripción iniciada durante la estancia.
--
-- A diferencia de la variante "predominant_unit", aquí los traslados
-- entre E073 e I073 dentro del mismo episodio generan DOS filas (una
-- por unidad). Reingresos: solo se cuentan los que abren un episodio
-- nuevo, no los traslados intra-episodio.
--
...
cohort AS (
    ...
    HAVING year(MIN(start_date)) BETWEEN 2019 AND 2025
),
...
SELECT DISTINCT
    ...
    CASE
        ...
        -- septiembre de 2022. Aceptamos ambas variantes.
